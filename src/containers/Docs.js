...
class Docs extends Component {
    ...
    render() {
        ...
        const {record, percent, sec, listItems, duration, isPaused, audioLoaded} = this.state;
            ...
            <div className="main-content">
                ...
                <div className="row">
                    ...
                    <div className="col-sm-7 sidearea player-div">
                        ...
                        <audio onLoadedData={this.audioLoaded} id="audio" onEnded={this.endProgress} src={`${ env.API_ROOT + record.blob_str}`} style={{display: "none"}}>
