...
import {Switch, CircularProgress} from "@material-ui/core/es/index";
...
class RegisterPayment extends Component {
    ...
    componentWillReceiveProps(nextProps, props) {
        ...
        this.setState({
            ...this.state, ...{validateErr: nextProps.message, registerIn: false}
        })
    }
    ...
    render() {
        ...
        const {validateErr, userInfo, coupon, couponErr, plan_type, registerIn} = this.state;
                                    ...
                                    <div className="d-flex plan-action">
                                        ...
                                        <span>
                                             ...
                                             <Switch
                                                 ...
                                                 color={'primary'}
                                                 value={plan_type==='startup-plan-yr' ? false : true}
                                             />
                            ...
                            <div className="col-sm-12 center-form register-payment">
                                ...
                                <form className="mt-5 mb-4">
                                    ...
                                    {registerIn}
                                        ...
                                        <button disabled={registerIn} type="button" onClick={this.makePayment}
                                                className="btn primary-btn"> 
                                            {
                                                !registerIn ? `Pay $ 13 USD` : <CircularProgress size={15} color={'white'}/>
                                            }
