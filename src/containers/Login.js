...
class Login extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({
            ...this.state,
            ...{ validationErr: nextProps.message, loggingIn: false }
        })
    }
                            ...
                            <div className="col-sm-12 center-form">
                                ...
                                <form onSubmit={this.handleLogin} className="mt-5 mb-4">
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <button disabled={this.state.loggingIn} type="submit" className="btn primary-btn">
                                            {
                                                this.state.loggingIn ? <CircularProgress size={15} color={'white'} /> : `Sign in`
                                            }
                                        </button>
