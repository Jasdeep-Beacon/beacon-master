...
class RecordStep4 extends Component {
    ...
    render() {
        ...
        const {recordTimer, audioStr, markers, recording, audioUrl, savingInterview} = this.state;
                ...
                <div className="row record-step4">
                    ...
                    <div className="offset-sm-3 col-sm-6">
                        ...
                        <div className="card text-center single">
                            ...
                            <button disabled={!audioStr || savingInterview} onClick={this.saveRecord}
                                    className="btn btn-primary"> { !savingInterview ? 'Save my interview' : 'Please wait...' }
                            </button>
    ...
    saveRecord = () => {
        this.setState({...this.state, ...{savingInterview: true}})
